...
<div class="text-left">
  <p class="text-2xl">{seasonStat.completions}/{seasonStat.attempts} <span class="text-xl">({`${completionPercentage(seasonStat.completions, seasonStat.attempts)}%`})</span></p>
  <p class="text-2xl">{seasonStat.yards} yards <span class="text-xl">({`${yardsPerAttempt(seasonStat.attempts, seasonStat.yards)} ypa`})</p>
